...
The final sub-clusters produced by Stage 5. Each image is a tightly-packed montage of that sub-cluster's images (up to the first 200), for **17 sub-clusters** in total (sub_0 – sub_16, contiguously numbered).
...
| sub_8 | 1014 | 25.2% | **Total** | **4020** | **100%** |
