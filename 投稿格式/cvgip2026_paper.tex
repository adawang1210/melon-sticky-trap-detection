...
\author[1]{Chen Kai}
\affil[1]{Department of Information Management, National Central University}
\affil[ ]{\texttt{adawang12101210@gmail.com}}
...
\midrule
\multicolumn{5}{l}{\textit{(a) Medoid re-estimation (mean$\pm$std over 3 seeds)}}\\
Full model (w/ medoid)  & $0.486{\pm}0.002$ & 1.17 & 1537 & --- \\
\;\; w/o medoid         & $0.466{\pm}0.009$ & 1.17 & 1200 & $-4.3\%$ \\
\midrule
...
The author thanks the Agricultural Engineering Research Center (AERC), Taiwan, for providing the yellow sticky-trap photographs from melon greenhouses used in this study.
