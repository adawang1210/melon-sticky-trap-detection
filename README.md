...
階段五對各群再細分後的最終子群，每張為該子群影像（最多前 200 張）的緊密拼貼預覽，共 **18 個子群**（缺 sub_7、sub_17；原 sub_7 已併入 sub_6）。

| sub_0 | sub_1 |
|:---:|:---:|
| ![sub_0](docs/images/sub_montages/sub_0.jpg) | ![sub_1](docs/images/sub_montages/sub_1.jpg) |
| **sub_2** | **sub_3** |
